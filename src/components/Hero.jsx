...
const Hero = () => {
  return (
    <div
      id="hero"
      className="min-h-screen flex flex-col items-center gap-10 justify-center text-center w-full max-w-[800px] mx-auto p-4"
    >
      ...
      <p className="text-sm md:text-lg font-light">
        ...
        <span className="text-blue-400 font-medium">unbelievably swole</span>{" "}
